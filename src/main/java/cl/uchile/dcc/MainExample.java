...
public class MainExample {
    public static void main(String[] args) throws InterruptedException, InvalidStatValueException {
        ...
        ArrayList<IWeapon> list_weapons = new ArrayList<>();
        ArrayList<PlayerCharacter> list_characters = new ArrayList<>();
        ArrayList<PlayerCharacter> list_characters_True = new ArrayList<>();
        ArrayList<PlayerCharacter> list_characters_False = new ArrayList<>();
        ...
        PlayerCharacter knight = new Knight("knight",1,1,queue);
        PlayerCharacter knight2 = new Knight("knight",1,1,queue);
        PlayerCharacter knight_distinto = new Knight("knight",2,2,queue);
        PlayerCharacter engineer = new Engineer("engineer",1,1,queue);
        PlayerCharacter engineer2 = new Engineer("engineer",1,1,queue);
        PlayerCharacter engineer_distinto = new Engineer("engineer",2,2,queue);
        PlayerCharacter thief = new Thief("thief",1,1,queue);
        PlayerCharacter thief2 = new Thief("thief",1,1,queue);
        PlayerCharacter thief_distinto = new Thief("thief",2,2,queue);
        PlayerCharacter whitemage = new WhiteMage("whitemage",1,1,1,queue);
        PlayerCharacter whitemage2= new WhiteMage("whitemage",1,1,1,queue);
        PlayerCharacter whitemage_distinto= new WhiteMage("whitemage",2,2,2,queue);
        PlayerCharacter blackmage = new BlackMage("blackmage",1,1,1,queue);
        PlayerCharacter blackmage2 = new BlackMage("blackmage",1,1,1,queue);
        PlayerCharacter blackmage_distinto = new BlackMage("blackmage",2,2,2,queue);
        Enemy enemy = new Enemy("enemy",1,1,1,queue);
        Enemy enemy2 = new Enemy("enemy",1,1,1,queue);
        Enemy enemy_distinto = new Enemy("enemy",2,2,2,queue);
        ...
        for (int i= 0; i<6;i++){
            if(i==5){
                System.out.println(enemy.equals(enemy_distinto));
            }
            else{
